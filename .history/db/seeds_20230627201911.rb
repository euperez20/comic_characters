...
origin_url = 'https://comicvine.gamespot.com/api/origins/?api_key=YOUR_API_KEY&format=json'
...
publisher_url = 'https://comicvine.gamespot.com/api/publishers/?api_key=YOUR_API_KEY&format=json'
...
character_url = 'https://comicvine.gamespot.com/api/characters/?api_key=YOUR_API_KEY&format=json'
